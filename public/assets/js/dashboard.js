(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      ...
      var salesTopData = {
          labels: ["Dimanche","Di", "Lundi", "lundi", "Mardi","mardi", "Mercredi", "mercredi", "Jeudi", "jeudi", "Vendredi", "vendredi", "Samedi"],
          datasets: [{
              label: 'Ce week',
    ...
    if ($("#marketingOverview").length) {
      ...
      var marketingOverviewData = {
          labels: ["Binza","Delvo", "Kitambo", "Makala", "Gombé", "Limete", "Matete", "Lemba", "Makala", "Nsele", "Ndjili", "Kimbaseke"],
          datasets: [{
              label: 'Nombre de livraison',
              data: [50, 30, 60, 70, 20, 40, 35, 45, 25, 20, 51, 10],
    ...
    if ($("#leaveReport").length) {
      ...
      var leaveReportData = {
          labels: ["Legumes", "Fruits", "Viandes", "Produits surgelés", "Boissons"],
          datasets: [{
              label: 'Last week',
              data: [18, 25, 39, 11, 24],
              backgroundColor: "#52CDFF",
