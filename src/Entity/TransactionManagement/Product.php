...
class Product
{
     ...
     * @ORM\JoinTable(name="distributeur_category")
     */
    private $distributeur;

    /**
     * @ORM\ManyToMany(targetEntity=User::class, inversedBy="products")
     * @ORM\JoinTable(name="fabricant_category")
     */
    private $fabricant;
    ...
    public function addDistributeur(User $distributeur): self
    {
    ...
    public function removeDistributeur(User $distributeur): self
    {
     ...
     * @return Collection|User[]
     */
    public function getFabricant(): Collection
    {
        return $this->fabricant;
    }

    public function addFabricant(User $fabricant): self
    {
        if (!$this->fabricant->contains($fabricant)) {
    ...
    public function removeFabricant(User $fabricant): self
    {
        $this->fabricant->removeElement($fabricant);
